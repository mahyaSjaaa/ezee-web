...
export default function Cardsrvc({
  url,
  labelAatas,
  harga,
  d1,
  ...
  <div className="group bg-[#042222] text-white hover:bg-[#00DF82] transition ease-in-out duration-200 hover:text-[#030F0F] border border-[#2CC297] flex flex-col justify-between rounded-lg min-h-[500px] px-4 py-6 hover:scale-105 hover:-translate-y-5">
    
    <div className="flex flex-col text-center">
      <h3 className={`${poppinsSB.className} text-[16px] mb-1`}>{labelAatas}</h3>
      ...
      <div className={`${poppins.className} text-left`}>
        ...
        <div className="flex gap-3 mb-1 items-start">
          {statRev ? <Check size={16} className="mt-[1.5px] flex-shrink-0" /> : <X size={16} className="mt-[1.5px] flex-shrink-0" />}
          <p className="text-[14px]">{d10}</p>
        </div>

        <div className="flex gap-3 mb-1 items-start">
          {statDom ? <Check size={16} className="mt-[1.5px] flex-shrink-0" /> : <X size={16} className="mt-[1.5px] flex-shrink-0" />}
          <p className="text-[14px]">{d9}</p>
        </div>
        <div className="flex gap-3 mb-1 items-start">
          {statEm ? <Check size={16} className="mt-[1.5px] flex-shrink-0" /> : <X size={16} className="mt-[1.5px] flex-shrink-0" />}
          <p className="text-[14px]">{d13}</p>
        </div>
