    ...
    return(
        <section className="bg-[#030F0F] h-full">
            ...
            <div className="pt-35 lg:px-30 md:px-20 sm:px-15 px-8">
                <h2 className={`${poppinsSB.className} text-white text-[24px] flex justify-center text-center lg:text-[32px] md:text-[32px] sm:text-[32px] text-[24px]`}>Penjelasan Lebih Lanjut Pilihan &quot;Sesuaikan sistem anda&quot;</h2>
                <div className="mt-4 flex-shrink-0 lg:text-[16px] md:text-[15px] sm:text-[14px] text-[14px]">
                    <div className={`${poppins.className} text-[#2CC297] flex gap-3 pb-1`}>
                        ...
                        <p className={`${poppins.className}`}>Pada pilihan ini anda dapat menyesuaikan fitur, konsep, dan seluruh kebutuhan anda.</p>
                    </div>
                    <div className={`${poppins.className} text-[#2CC297] flex gap-3 pb-1`}>
                        <Check size={16} className="mt-[3.5px] flex-shrink-0" />
                        <p className={`${poppins.className}`}>Pada pilihan ini anda bebas menyesuaikan kebutuhan website anda dengan maksimal 3 pages. Apabila konsep dan kebutuhan website anda melebihi 3 page, kami menyarankan memilih paket &quot;Pegang Kendali Penuh Website Anda&quot;.</p>
                    </div>
                    <div className={`${poppins.className} text-[#2CC297] flex gap-3 pb-1`}>
                        <Check size={16} className="mt-[3.5px] flex-shrink-0" />
                        <p className={`${poppins.className}`}>Waktu pengerjaan selama 5-10 hari setelah kedua pihak (anda dan kami) sepakat mengenai sistem, konsep, fitur, harga, dan setelah dilakukan Dp 15%</p>
                    </div>
                    <div className={`${poppins.className} text-[#2CC297] flex gap-3 pb-1`}>
                        <Check size={16} className="mt-[3.5px] flex-shrink-0" />
                        <p className={`${poppins.className}`}>Range harga pada pilihan ini dimulai dari Rp. 889.000 hingga Rp. 2.400.000 sesuai dengan permintaan fitur dan konsep.</p>
                    </div>
                    <div className={`${poppins.className} text-[#2CC297] flex gap-3 pb-1`}>
                        <Check size={16} className="mt-[3.5px] flex-shrink-0" />
                ...
                <div className="flex justify-center py-15 mx-1">
                    <a href="https://wa.me/6289666823165?text=halo%2C%20kak.%20saya%20ingin%20membuat%20website%20paket%20Sesuaikan_sistem_anda">
